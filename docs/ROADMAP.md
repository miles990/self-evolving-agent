...
| 任務 | 優先級 | 預期產出 |
|------|--------|----------|
| 用 /evolve 完成一個真實任務 | 高 | 產生 1+ failure/lesson 記錄 |
| 填充 emergence-metrics.yaml | 高 | 基線數據 |
| 填充 skill-metrics/index.md | 中 | 技能效果追蹤 |
| 記錄首個 ADR 決策 | 中 | decisions/001-*.md |
...
### Phase 1 完成標準
- [ ] Memory 系統有 ≥5 筆真實記錄 (非範例)
- [ ] CP5 至少觸發過 2 次
- [ ] emergence-metrics.yaml 有非零數據
